  ...
  allPosts = [
    {
      ...
      content: `
        <h2 class="text-3xl font-black text-[#0d1a0f] mb-6">Understanding Riba in Islamic Finance</h2>
        <p class="mb-6 text-[#6B7280] leading-relaxed text-lg">
        ...
        <blockquote class="border-l-4 border-[#1B4332] pl-6 my-10 italic text-2xl text-[#1B4332] font-medium leading-tight">
        ...
        <h3 class="text-2xl font-black text-[#0d1a0f] mb-4">How Dogo Finance Operates Riba-Free</h3>
        <p class="mb-6 text-[#6B7280] leading-relaxed text-lg">
    ...
    },
    {
      ...
      content: `
        ...
        <h3 class="text-2xl font-black text-[#0d1a0f] mb-4">1. Mudarabah (Profit-Sharing)</h3>
        <p class="mb-6 text-[#6B7280] leading-relaxed text-lg">The cornerstone of Halal investing. You provide the capital, DOGO Finance manages it. Profits are shared 70/30.</p>
        
        <h3 class="text-2xl font-black text-[#0d1a0f] mb-4">2. Sukuk (Islamic Bonds)</h3>
        <p class="mb-6 text-[#6B7280] leading-relaxed text-lg">Unlike conventional bonds which are debt instruments, Sukuk represent ownership in a tangible asset.</p>
        
        <h3 class="text-2xl font-black text-[#0d1a0f] mb-4">3. Halal Equities</h3>
        <p class="mb-6 text-[#6B7280] leading-relaxed text-lg">Invest in listed stocks that have been fully screened to exclude Haram sectors like alcohol and conventional banking.</p>
      `
    },
    {
